...
from .layers import netVLAD as netVLAD_layer

# TODO: smarter way! 
def defaultCheckpoint():
#     return '/home/anil/DocumentsActiveAI/ESN-VPR/src/netVLAD/checkpoints/'
    return '/home/anil/Documents/ActiveAI/ESN-VPR/src/netVLAD/checkpoints/vd16_pitts30k_conv5_3_vlad_preL2_intra_white'
    ...
    with tf.compat.v1.variable_scope('vgg16_netvlad_pca'):
        ...
        def vggConv(inputs, numbers, out_dim, with_relu):
            if with_relu:
                ...
                activation = None
            return tf.layers.conv2d(inputs, out_dim, [3, 3], 1, padding='same', activation=activation, name='conv%s' % numbers)
