...
def evaluate(gt_positions, closest_match_idcs, closest_match_dists2, closest_gt_dists2, gt_radius):
    ...
    relevant_size = np.count_nonzero(closest_gt_dists2[sort_i] < gt_radius ** 2)
